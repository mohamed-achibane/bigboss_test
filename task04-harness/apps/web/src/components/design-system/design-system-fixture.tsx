          ...
          <ControlPanelFrame>
            <div className="grid gap-3 sm:grid-cols-2">
              <InfrastructurePanel>
                <div
                  aria-hidden="true"
                  className="mb-5 size-5 rounded-md bg-primary"
                />
                <p className="font-semibold">Illustration surface</p>
                <p className="mt-1 text-sm text-muted-foreground">
                  No customer or live system data.
                </p>
              </InfrastructurePanel>
              <InfrastructurePanel>
        ...
        <Container>
          ...
          <FeatureGrid>
            {[
              [
                "Feature grid",
                "Responsive content grouping with semantic surfaces.",
              ],
              [
                "Trust section",
                "Designed for evidence-backed statements only.",
              ],
              [
                "Infrastructure",
                "Illustration frames never imply live status.",
              ],
            ].map(([title, copy]) => (
              <Card key={title}>
                <CardHeader>
      ...
      <Section>
        <Container>
          <Callout title="Status semantics">
            Status components are presentation labels only. They must not be
            used as a live uptime or service-health indicator unless a later
            task supplies a real authoritative status source.
          </Callout>
        </Container>
      </Section>

      <section
        className="dark bg-background py-16 text-foreground"
        data-theme-preview="dark"
      >
        <Container>
          <p className="text-xs font-bold uppercase tracking-[var(--tracking-label)] text-primary">
            Dark theme contrast fixture
          </p>
          <h2 className="mt-3 text-[length:var(--text-h2)] font-semibold">
            The same semantic components, one alternate theme.
          </h2>
          <p className="mt-4 max-w-2xl text-muted-foreground">
            Dark mode overrides semantic tokens rather than duplicating
            component rules.
          </p>
